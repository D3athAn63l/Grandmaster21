...
Physician** vertical slice, which has **not** been tested in gameplay. The Shooting capstone has
been verified in real RimWorld 1.6 gameplay; Melee has not. See [Release status](#release-status).
