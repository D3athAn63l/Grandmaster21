...
"$COMPILER" -nologo -target:exe -out:"$OUT/transcendent.exe" -nostdlib -noconfig -warn:2 \
  ...
  -r:"$OUT/Mono.Cecil.dll" -r:"$OUT/Grandmaster21.dll" Tests/TranscendentChecks.cs Tests/TranscendentCompletionChecks.cs Tests/TranscendentSurgicalChecks.cs Tests/TranscendentFeedbackChecks.cs
